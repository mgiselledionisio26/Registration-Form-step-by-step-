...
<div class='title'> STUDENT REGISTRATION </div>
	...
	<tr>
		<td><input type ="text" name="f_name" size ="20" placeholder="Ma Giselle" required  value="<?php echo $first_name;?>"></td>
		<td><input type ="text" name="m_name" size ="20" placeholder="Olvina" required value="<?php echo $middle_name;?>"></td>
		<td><input type ="text" name="l_name" size ="20" placeholder="Dionisio" required value="<?php echo $last_name;?>"></td>
	</tr>
	<tr>
		<td>Gender </td>
	...
	<tr> 
	<td width ="496" colspan ="3">Address</td>
	</tr>
	<tr>
	<td><textarea id="address" cols= "70" rows ="5" name="text"> </textarea></td>
	</tr>
	<tr>
